...
$query = "SELECT * FROM req_history WHERE user_id = '$user_id' AND name LIKE '%$search%'";
...
<head>
    ...
    <link rel="stylesheet" href="ree_q.css">
</head>
<body>
    <header>
    <nav>   
            ...
            <table border="1" cellspacing="40" cellpadding="10">
                ...
                if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                                <form method='post' action='editreq.php' style='display:inline;'>
                        ...
                        if ($row['status'] == 'pending') {
                            echo "<div class='message message-info'></div>";
                        }
                        echo "</td>";
                        echo "</tr>";
                    }
